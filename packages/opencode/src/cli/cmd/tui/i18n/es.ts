...
export const dict = {
  ...
  "tui.tips.mcp_oauth":
    "Mimo Desktop gestiona automáticamente OAuth para servidores MCP remotos que requieran autenticación",
  "tui.tips.custom_command":
    "Añade archivos {highlight}.md{/highlight} en {highlight}.mimo/command/{/highlight} para definir indicaciones personalizadas reutilizables",
  ...
  "tui.tips.custom_agent":
    "Añade archivos {highlight}.md{/highlight} en {highlight}.mimo/agent/{/highlight} para personajes de IA especializados",
  ...
  "tui.tips.formatter": "Mimo Desktop formatea archivos automáticamente con prettier, gofmt, ruff y más",
  ...
  "tui.tips.lsp": "Mimo Desktop usa servidores LSP para análisis inteligente de código",
  "tui.tips.custom_tool":
    "Crea archivos {highlight}.ts{/highlight} en {highlight}.mimo/tools/{/highlight} para definir nuevas herramientas LLM",
  "tui.tips.tool_scripts":
    "Las definiciones de herramientas pueden invocar scripts en Python, Go, etc.",
  "tui.tips.plugins":
    "Añade archivos {highlight}.ts{/highlight} en {highlight}.mimo/plugin/{/highlight} para enganchar eventos",
  ...
  "tui.tips.plugin_protect":
    "Crea un plugin que impida a Mimo Desktop leer archivos sensibles",
  "tui.tips.run":
  ...
  "tui.tips.serve":
    "Ejecuta {highlight}mimo serve{/highlight} para acceso headless a la API de Mimo Desktop",
  ...
  "tui.tips.theme_files":
    "Crea archivos JSON de tema en el directorio {highlight}.mimo/themes/{/highlight}",
  ...
  "tui.command.mimo.status.title": "Ver estado",
