  ...
  const template: Electron.MenuItemConstructorOptions[] = [
    ...
    },
    {
      ...
      submenu: [
        ...
        { type: "separator" },
        { label: "Toggle Memory Panel", accelerator: "Cmd+Shift+M", click: () => deps.trigger("mimo.memory.toggle") },
        {
          label: "Toggle Sub-Agents",
          accelerator: "Cmd+Shift+A",
          click: () => deps.trigger("mimo.subagents.toggle"),
        },
        { type: "separator" },
        { role: "reload" },
        { role: "toggleDevTools" },
    ...
    },
    {
      ...
      submenu: [
        {
          label: "Start Dream Cycle",
          accelerator: "Cmd+Shift+D",
          click: () => deps.trigger("mimo.dream.start"),
        },
        {
          label: "Distill Knowledge",
          accelerator: "Cmd+Shift+K",
          click: () => deps.trigger("mimo.distill.run"),
        },
        { type: "separator" },
        {
          label: "View Memory",
          accelerator: "Cmd+Shift+M",
          click: () => deps.trigger("mimo.memory.toggle"),
        },
        {
          label: "Clear Session Memory",
          click: () => deps.trigger("mimo.memory.clear"),
        },
        { type: "separator" },
        {
          label: "Show Sub-Agent Monitor",
          accelerator: "Cmd+Shift+A",
          click: () => deps.trigger("mimo.subagents.toggle"),
        },
        {
          label: "Stop All Sub-Agents",
          click: () => deps.trigger("mimo.subagents.stopAll"),
        },
      ],
    },
    { role: "windowMenu" },
    {
      ...
      submenu: [
        {
          label: "Mimo Documentation",
          click: () => shell.openExternal("https://github.com/taisrisk/mimo-desktop"),
        },
        {
          label: "Report an Issue",
          click: () => shell.openExternal("https://github.com/taisrisk/mimo-desktop/issues/new"),
        },
      ],
    },
  ]
