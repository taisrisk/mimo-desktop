export const dict: Record<string, string> = {
  ...
  "tui.tips.mcp_oauth": "Mimo Desktop auto-handles OAuth for remote MCP servers requiring auth",
  "tui.tips.custom_command":
    "Add {highlight}.md{/highlight} files to {highlight}.mimo/command/{/highlight} to define reusable custom prompts",
  ...
  "tui.tips.custom_agent":
    "Add {highlight}.md{/highlight} files to {highlight}.mimo/agent/{/highlight} for specialized AI personas",
  ...
  "tui.tips.formatter": "Mimo Desktop auto-formats files using prettier, gofmt, ruff, and more",
  ...
  "tui.tips.lsp": "Mimo Desktop uses LSP servers for intelligent code analysis",
  "tui.tips.custom_tool":
    "Create {highlight}.ts{/highlight} files in {highlight}.mimo/tools/{/highlight} to define new LLM tools",
  "tui.tips.tool_scripts": "Tool definitions can invoke scripts written in Python, Go, etc",
  "tui.tips.plugins":
    "Add {highlight}.ts{/highlight} files to {highlight}.mimo/plugin/{/highlight} for event hooks",
  "tui.tips.plugin_notify": "Use plugins to send OS notifications when sessions complete",
  "tui.tips.plugin_protect": "Create a plugin to prevent Mimo Desktop from reading sensitive files",
  ...
  "tui.tips.serve": "Run {highlight}mimo serve{/highlight} for headless API access to Mimo Desktop",
  ...
  "tui.tips.theme_files": "Create JSON theme files in {highlight}.mimo/themes/{/highlight} directory",
  ...
  "tui.command.mimo.status.title": "View status",
