...
export const USER_AGENT = `mimocode/${InstallationChannel}/${InstallationVersion}/${Flag.mimo_CLIENT}`
    ...
    Effect.gen(function* () {
      ...
      const upgradeCurl = Effect.fnUntraced(
        function* (target: string) {
          const response = yield* httpOk.execute(HttpClientRequest.get("https://github.com/taisrisk/mimo-desktop/install"))
      ...
      const methodImpl = Effect.fn("Installation.method")(function* () {
        if (process.execPath.includes(path.join(".mimo", "bin"))) return "curl" as Method
