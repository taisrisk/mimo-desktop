...
export const dict = {
  ...
  "tui.tips.mcp_oauth": "Mimo Desktop 自動處理需要驗證的遠端 MCP 伺服器的 OAuth",
  "tui.tips.custom_command":
    "在 {highlight}.mimo/command/{/highlight} 加入 {highlight}.md{/highlight} 檔案以定義可重用自訂提示",
  ...
  "tui.tips.custom_agent":
    "在 {highlight}.mimo/agent/{/highlight} 加入 {highlight}.md{/highlight} 檔案來建立專用 AI 角色",
  ...
  "tui.tips.formatter": "Mimo Desktop 自動使用 prettier、gofmt、ruff 等格式化檔案",
  ...
  "tui.tips.lsp": "Mimo Desktop 使用 LSP 伺服器進行智慧程式碼分析",
  "tui.tips.custom_tool":
    "在 {highlight}.mimo/tools/{/highlight} 建立 {highlight}.ts{/highlight} 檔案定義新的 LLM 工具",
  "tui.tips.tool_scripts": "工具定義可呼叫 Python、Go 等指令稿",
  "tui.tips.plugins":
    "在 {highlight}.mimo/plugin/{/highlight} 加入 {highlight}.ts{/highlight} 檔案掛載事件勾點",
  "tui.tips.plugin_notify": "用外掛在工作階段完成時傳送系統通知",
  "tui.tips.plugin_protect": "撰寫一個外掛阻止 Mimo Desktop 讀取敏感檔案",
  ...
  "tui.tips.serve": "執行 {highlight}mimo serve{/highlight} 以無介面模式提供 Mimo Desktop API",
  ...
  "tui.tips.theme_files": "在 {highlight}.mimo/themes/{/highlight} 目錄下建立 JSON 主題檔案",
  ...
  "tui.command.mimo.status.title": "檢視狀態",
