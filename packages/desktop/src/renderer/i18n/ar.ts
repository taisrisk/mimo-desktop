export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من Mimo Desktop",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من Mimo Desktop، هل ترغب في تثبيته وإعادة تشغيله؟",
