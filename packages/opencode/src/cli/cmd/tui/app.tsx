...
function App(props: { onSnapshot?: () => Promise<string[]> }) {
  ...
  createEffect(() => {
    ...
    if (route.data.type === "home") {
      renderer.setTerminalTitle("Mimo Desktop")
      return
    }
  ...
  command.register(() => [
    ...
    ...(sync.data.console_state.switchableOrgCount > 1
      ...
      : []),
    {
      title: t("tui.command.mimo.status.title"),
      keybind: "status_view",
    ...
    },
    {
      ...
      onSelect: () => {
        open("https://github.com/taisrisk/mimo-desktop/docs").catch(() => {})
        dialog.clear()
      },
      category: "system",
    },
  ...
  event.on("installation.update-available", async (evt) => {
    ...
    await DialogAlert.show(
      dialog,
      "Update Complete",
      `Successfully updated to Mimo Desktop v${result.data.version}. Please restart the application.`,
    )
