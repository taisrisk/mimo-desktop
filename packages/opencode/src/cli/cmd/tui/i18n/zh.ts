...
export const dict = {
  ...
  "tui.tips.mcp_oauth": "Mimo Desktop 自动处理需要鉴权的远程 MCP 服务器的 OAuth",
  "tui.tips.custom_command":
    "在 {highlight}.mimo/command/{/highlight} 添加 {highlight}.md{/highlight} 文件以定义可复用自定义提示",
  ...
  "tui.tips.custom_agent":
    "在 {highlight}.mimo/agent/{/highlight} 添加 {highlight}.md{/highlight} 文件来创建专用 AI 角色",
  ...
  "tui.tips.formatter": "Mimo Desktop 自动使用 prettier、gofmt、ruff 等格式化文件",
  ...
  "tui.tips.lsp": "Mimo Desktop 使用 LSP 服务器进行智能代码分析",
  "tui.tips.custom_tool":
    "在 {highlight}.mimo/tools/{/highlight} 创建 {highlight}.ts{/highlight} 文件定义新的 LLM 工具",
  "tui.tips.tool_scripts": "工具定义可以调用 Python、Go 等脚本",
  "tui.tips.plugins":
    "在 {highlight}.mimo/plugin/{/highlight} 添加 {highlight}.ts{/highlight} 文件挂接事件钩子",
  "tui.tips.plugin_notify": "用插件在会话完成时发送系统通知",
  "tui.tips.plugin_protect": "写一个插件阻止 Mimo Desktop 读取敏感文件",
  ...
  "tui.tips.serve": "运行 {highlight}mimo serve{/highlight} 以无头模式提供 Mimo Desktop API",
  ...
  "tui.tips.theme_files": "在 {highlight}.mimo/themes/{/highlight} 目录下创建 JSON 主题文件",
  ...
  "tui.command.mimo.status.title": "查看状态",
