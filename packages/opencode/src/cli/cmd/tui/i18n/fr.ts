...
export const dict = {
  ...
  "tui.tips.mcp_oauth":
    "Mimo Desktop gère automatiquement OAuth pour les serveurs MCP distants nécessitant une authentification",
  "tui.tips.custom_command":
    "Ajoutez des fichiers {highlight}.md{/highlight} dans {highlight}.mimo/command/{/highlight} pour définir des invites personnalisées réutilisables",
  ...
  "tui.tips.custom_agent":
    "Ajoutez des fichiers {highlight}.md{/highlight} dans {highlight}.mimo/agent/{/highlight} pour des personas IA spécialisés",
  ...
  "tui.tips.formatter": "Mimo Desktop formate automatiquement les fichiers avec prettier, gofmt, ruff, etc.",
  ...
  "tui.tips.lsp": "Mimo Desktop utilise des serveurs LSP pour une analyse de code intelligente",
  "tui.tips.custom_tool":
    "Créez des fichiers {highlight}.ts{/highlight} dans {highlight}.mimo/tools/{/highlight} pour définir de nouveaux outils LLM",
  "tui.tips.tool_scripts": "Les définitions d'outils peuvent invoquer des scripts en Python, Go, etc.",
  "tui.tips.plugins":
    "Ajoutez des fichiers {highlight}.ts{/highlight} dans {highlight}.mimo/plugin/{/highlight} pour des hooks d'événements",
  ...
  "tui.tips.plugin_protect":
    "Créez un plugin pour empêcher Mimo Desktop de lire des fichiers sensibles",
  ...
  "tui.tips.serve": "Exécutez {highlight}mimo serve{/highlight} pour exposer l'API Mimo Desktop en mode headless",
  ...
  "tui.tips.theme_files":
    "Créez des fichiers de thème JSON dans le dossier {highlight}.mimo/themes/{/highlight}",
  ...
  "tui.command.mimo.status.title": "Voir l'état",
