...
const releaseId = process.env.MIMO_RELEASE
if (!releaseId) throw new Error("MIMO_RELEASE is required")

const version = process.env.MIMO_VERSION
if (!version) throw new Error("MIMO_VERSION is required")
...
const macxTarGz = "mimo-desktop-mac-x64.app.tar.gz"
const macaTarGz = "mimo-desktop-mac-arm64.app.tar.gz"
