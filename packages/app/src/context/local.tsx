...
export const { use: useLocal, provider: LocalProvider } = createSimpleContext({
  ...
  init: () => {
    ...
    const DEFAULT_AGENTS = [
      { name: "build", color: "#fb8147", description: "Executes tools based on configured permissions.", mode: "primary" as const, hidden: false, model: undefined, variant: undefined },
      { name: "plan", color: "#c7e2a8", description: "Plan mode. Disallows all edit tools.", mode: "primary" as const, hidden: false, model: undefined, variant: undefined },
      { name: "compose", color: "#a7a3d8", description: "Compose mode. Orchestrates workflows with built-in compose skills.", mode: "primary" as const, hidden: false, model: undefined, variant: undefined },
    ]
    ...
    const validModel = (model: ModelKey) => {
      if (model.providerID === "mimo" && model.modelID === "mimo-auto") return true
    ...
    const defaultModel = () => {
      ...
      return { providerID: "mimo" as const, modelID: "mimo-auto" as const }
    }
    ...
    const current = () => {
      ...
      if (item.providerID === "mimo" && item.modelID === "mimo-auto") {
        return {
          id: "mimo-auto",
          name: "MiMo Auto",
          provider: { id: "mimo", name: "MiMo Auto (free)" } as any,
          status: "active" as const,
          capabilities: { temperature: true, reasoning: true, attachment: true, toolcall: true, input: { text: true, audio: false, image: true, video: false, pdf: false }, output: { text: true, audio: false, image: false, video: false, pdf: false }, interleaved: false },
