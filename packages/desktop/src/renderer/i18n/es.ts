export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Mimo Desktop",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Mimo Desktop. ¿Quieres instalarla y reiniciar?",
