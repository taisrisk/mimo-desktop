export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Mimo Desktop",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Mimo Desktop wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
